...
export const educationLogos = {
  "Tamheen-GIZ-EITIA": null,
  "IDS Salé & GIZ Maroc (Projet Tamheen II)": [
    { src: "/logos/ids-sale.png", alt: "IDS Salé" },
    { src: "/logos/giz.png", alt: "GIZ Maroc" }
  ],
  "SUPMTI": { src: "/logos/supmti.png", alt: "SUPMTI Rabat" },
  "ISTA Chmaou": { src: "/logos/ista-ofppt.png", alt: "ISTA Chmaou OFPPT" },
};
